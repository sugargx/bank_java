 ...
 */
public class showMoney_transFrame extends javax.swing.JFrame {
    ...
    public showMoney_transFrame(double money) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showMoney_transFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showMoney_transFrame(money).setVisible(true);
            }
        });
    }
